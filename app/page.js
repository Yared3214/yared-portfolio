    ...
    <main className="flex min-h-screen flex-col items-center justify-between px-36">
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="col-span-2">
          {/* About section */}
          <section id="about" className="min-h-[50vh] py-24">
            <p>
              I am a Computer Science graduate from Addis Ababa University and a passionate frontend React Native mobile app developer. 
              I specialize in building cross-platform mobile applications with React Native, focusing on delivering smooth user experiences and responsive designs. 
              In addition to mobile development, I also work with React.js and Next.js for creating dynamic and scalable web applications. 
              My career goal is to contribute to impactful projects in the tech industry while continuously improving my skills as a frontend developer.
            </p>
          </section>

          {/* Skills section */}
          <section id="skills" className="min-h-[50vh]">
            <div className="text-3xl text-white mb-5">Frontend / Mobile Skills</div>
            {frontSkills.map((skill, index) => (
              <div key={index} className="group relative grid pb-1 transition-all sm:grid-cols-4 sm:gap-8 md:gap-4 lg:hover:!opacity-100 
                ...
                <div className="col-span-3">
                  ...
                  <ul className="mt-2 flex flex-wrap" aria-label="Technologies Used Together">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4">
              <div className="flex flex-col items-center">
                <img src="https://i.ibb.co/PZM6bqB/debugging.png" alt="Problem-Solving & Debugging Icon" className="w-16 h-16" />
                <p className="mt-2 text-center text-lg font-semibold">Problem-Solving & Debugging</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://cdn-icons-png.flaticon.com/512/2535/2535547.png" alt="Responsive Design Icon" className="w-16 h-16" />
                <p className="mt-2 text-center text-lg font-semibold">Responsive Design</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://img.icons8.com/color/48/000000/figma.png" alt="Figma Icon" className="w-16 h-16" />
                <p className="mt-2 text-center text-lg font-semibold">Design Tools (Figma)</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://static.vecteezy.com/system/resources/thumbnails/000/534/837/small/gdpr_line_solid-13.jpg" alt="Collaboration Icon" className="w-16 h-16" />
                <p className="mt-2 text-center text-lg font-semibold">Collaboration & Communication</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://img.icons8.com/color/48/000000/git.png" alt="Version Control Icon" className="w-16 h-16" />
                <p className="mt-2 text-center text-lg font-semibold">Version Control (Git)</p>
              </div>
            </div>
          </section>
        </div>
